...
(async () => {
  ...
  console.log(nftReceiver.publicKey.toBase58(), 'Receiver addr')

  try {
    await transfer_tokens(myKeypair, connection, 1, receiver_token_account, my_token_account)
  } catch (error) {
    console.log(error)
  }
