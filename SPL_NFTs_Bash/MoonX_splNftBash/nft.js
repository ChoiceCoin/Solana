...
const nftMintRequest = new theblockchainapi.NFTMintRequest(); 
nftMintRequest.secret_recovery_phrase = new_seed_phrase;
nftMintRequest.nft_name = 'MoonX NFT'
nftMintRequest.nft_symbol = 'solnft'
nftMintRequest.mint_to_public_key = "GN4VCxyGgCY7gQmiZTn8FXvjEWdXQ7xLGqSjhi2zYWPQ";
opts = {
